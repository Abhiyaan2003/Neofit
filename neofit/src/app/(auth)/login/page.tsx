    ...
    <div className="min-h-screen bg-[#0F1115] flex flex-col items-center justify-center px-6 py-12">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="text-center mb-8">
          ...
          <p className="text-[#A8B0BE] text-sm">Sign in to continue your training</p>
        </motion.div>
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-[#1D212B] border border-white/8 text-sm font-medium hover:bg-[#222733] hover:border-white/12 transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-5"
        >
          {isGoogleLoading ? (
            <div className="w-4 h-4 border-2 border-[#A8B0BE] border-t-transparent rounded-full animate-spin" />
          ) : (
        ...
        <motion.p variants={fadeUp} className="text-center text-sm text-[#A8B0BE] mt-6">
          ...
          <Link href="/register" className="text-[#8BAE9E] hover:text-[#A3C4B4] font-medium transition-colors">
            Sign up
          </Link>
        </motion.p>
      </motion.div>
